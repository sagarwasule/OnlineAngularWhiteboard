...
define(['application-configuration'],
    function () {
        ...
        app.service('whiteboardHubService', [function () {
            ...
            this.handleDraw = function (message, sessionToken, clientId, updatecanvas) {

                whiteboardHub = $.connection.onlineHub;
                whiteboardHub.client.handleDraw = function (message, sessionToken, clientId) {
                    //console.log("handle draw -- " + message);
